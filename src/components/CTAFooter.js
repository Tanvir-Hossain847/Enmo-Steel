export default function CTAFooter() {
  const ctaOptions = [
    ...
    },
    {
      ...
      description: "Dive into our educational resources and expand your botanical knowledge today.",
  ...
  return (
    <section className="py-20 bg-secondary/10 relative overflow-hidden">
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 right-20 w-24 h-24 border border-secondary/20 rounded-full animate-pulse"></div>
      <div className="absolute bottom-32 left-16 w-16 h-16 border border-secondary/30 rounded-full animate-bounce"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {ctaOptions.map((option, index) => (
              <div 
                key={index}
                className="bg-white border-2 border-black hover:border-secondary transition-all duration-300 group text-center shadow-lg"
              >
                <div className="p-8">
                  <div className="text-5xl mb-6">{option.icon}</div>
                  <h3 className="text-xl font-bold text-black group-hover:text-secondary transition-colors mb-4">
                    {option.title}
                  </h3>
                  ...
                  <button className={`btn ${option.buttonStyle} btn-lg w-full ${
                    option.buttonStyle === 'btn-secondary' 
                      ? 'text-white hover:bg-secondary/90' 
            ...
            <div className="max-w-md mx-auto">
              <div className="join w-full">
                <input 
                  ...
                  className="input input-bordered input-lg join-item flex-1 border-2 border-black focus:border-secondary focus:outline-none" 
                />
                <button className="btn btn-secondary btn-lg join-item px-6 text-white hover:bg-secondary/90">
                  Subscribe
                </button>
              </div>
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-4 bg-secondary/20 border-2 border-secondary px-8 py-4 mb-6">
            ...
            <div>
              <button className="btn btn-secondary btn-lg text-white hover:bg-secondary/90 shadow-lg mr-4">
                Begin Your Journey
              </button>
